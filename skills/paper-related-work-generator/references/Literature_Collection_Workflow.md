...
- 会议论文：`[序号] 作者. 题名[C]//会议名. 出版地: 出版者, 年: 页码.`
- 学位论文：`[序号] 作者. 题名[D]. 保存地: 保存单位, 年.`
- 电子文献：`[序号] 作者. 题名[EB/OL]. (发布日期)[引用日期]. 网址.`
- 标准：`[序号] 标准编号, 标准名称[S].`

**作者著录规则：**
- 1-3人：全部列出，如 `张三, 李四, 王五.` 或 `Smith J, Johnson M.`
- >3人：前3人 + ", 等"或", et al"，如 `张三, 李四, 王五, 等.` 或 `Brown T, Mann B, Ryder N, et al.`
---
